...
namespace biz.Fin
{
	public class BillGroupBiz : BaseBiz
	{
		#region Properties
		...
		private BillGroupDataAccess _datalayer;
		private BillGroupDataAccess DataLayer
		{
			get { if (_datalayer == null) _datalayer = new BillGroupDataAccess(); return _datalayer; }
		...
		public BillGroupBiz () 
		{}
		public BillGroupBiz ( Context _context ) :base(_context)
		{}
		#endregion
