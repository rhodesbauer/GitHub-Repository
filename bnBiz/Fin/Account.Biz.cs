...
namespace biz.Fin
{
	public class AccountBiz : BaseBiz
	{
		...
		private AccountDataAccess _datalayer;
		private AccountDataAccess DataLayer
		{
			get { if (_datalayer == null) _datalayer = new AccountDataAccess(); return _datalayer; }
		...
		public AccountBiz () 
		{}
		public AccountBiz ( Context _context ) :base(_context)
		{}
		#endregion
