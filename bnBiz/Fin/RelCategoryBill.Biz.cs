...
{
	public class RelCategoryBillBiz : BaseBiz
	{
		#region Properties
		...
		private RelCategoryBillDataAccess _datalayer;
		private RelCategoryBillDataAccess DataLayer
		{
			get { if (_datalayer == null) _datalayer = new RelCategoryBillDataAccess(); return _datalayer; }
			set { _datalayer = value; }
		}
		#endregion
		#region Constructors
		
		public RelCategoryBillBiz () 
		{}
		public RelCategoryBillBiz ( Context _context ) :base(_context)
		{}
		#endregion
