...
namespace biz.Fin
{
	public class BillBiz : BaseBiz
	{
		...
		private BillDataAccess _datalayer;
		private BillDataAccess DataLayer
		{
			get { if (_datalayer == null) _datalayer = new BillDataAccess(); return _datalayer; }
		...
		public BillBiz () 
		{}
		public BillBiz ( Context _context ) :base(_context)
		{}
		#endregion
