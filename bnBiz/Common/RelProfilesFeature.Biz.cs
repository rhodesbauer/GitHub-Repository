...
{
	public class RelProfilesFeatureBiz : BaseBiz
	{
		#region Properties
		...
		private RelProfilesFeatureDataAccess _datalayer;
		private RelProfilesFeatureDataAccess DataLayer
		{
			get { if (_datalayer == null) _datalayer = new RelProfilesFeatureDataAccess(); return _datalayer; }
			set { _datalayer = value; }
		}
		#endregion
		#region Constructors
		
		public RelProfilesFeatureBiz () 
		{}
		public RelProfilesFeatureBiz ( Context _context ) :base(_context)
		{}
		#endregion
