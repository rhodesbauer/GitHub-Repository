...
{
	public class PhoneNumberBiz : BaseBiz
	{
		#region Properties
		...
		private PhoneNumberDataAccess _datalayer;
		private PhoneNumberDataAccess DataLayer
		{
			get { if (_datalayer == null) _datalayer = new PhoneNumberDataAccess(); return _datalayer; }
			set { _datalayer = value; }
		}
		#endregion
		#region Constructors
		
		public PhoneNumberBiz () 
		{}
		public PhoneNumberBiz ( Context _context ) :base(_context)
		{}
		#endregion
