...
namespace biz.Common
{
	public class StatuBiz : BaseBiz
	{
		...
		private StatuDataAccess _datalayer;
		private StatuDataAccess DataLayer
		{
			get { if (_datalayer == null) _datalayer = new StatuDataAccess(); return _datalayer; }
		...
		public StatuBiz () 
		{}
		public StatuBiz ( Context _context ) :base(_context)
		{}
		#endregion
