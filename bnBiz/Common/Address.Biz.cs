...
{
	public class AddresseBiz : BaseBiz
	{
		#region Properties
		...
		private AddresseDataAccess _datalayer;
		private AddresseDataAccess DataLayer
		{
			get { if (_datalayer == null) _datalayer = new AddresseDataAccess(); return _datalayer; }
		...
		public AddresseBiz () 
		{}
		public AddresseBiz ( Context _context ) :base(_context)
		{}
		#endregion
