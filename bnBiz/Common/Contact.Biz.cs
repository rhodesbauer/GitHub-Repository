...
{
	public class ContactBiz : BaseBiz
	{
		#region Properties
		...
		private ContactDataAccess _datalayer;
		private ContactDataAccess DataLayer
		{
			get { if (_datalayer == null) _datalayer = new ContactDataAccess(); return _datalayer; }
		...
		public ContactBiz () 
		{}
		public ContactBiz ( Context _context ) :base(_context)
		{}
		#endregion
