...
namespace biz.Common
{
	public class CitieBiz : BaseBiz
	{
		...
		private CitieDataAccess _datalayer;
		private CitieDataAccess DataLayer
		{
			get { if (_datalayer == null) _datalayer = new CitieDataAccess(); return _datalayer; }
		...
		public CitieBiz () 
		{}
		public CitieBiz ( Context _context ) :base(_context)
		{}
		#endregion
