...
namespace biz.Common
{
	public class TypeBiz : BaseBiz
	{
		...
		private TypeDataAccess _datalayer;
		private TypeDataAccess DataLayer
		{
			get { if (_datalayer == null) _datalayer = new TypeDataAccess(); return _datalayer; }
		...
		public TypeBiz () 
		{}
		public TypeBiz ( Context _context ) :base(_context)
		{}
		#endregion
