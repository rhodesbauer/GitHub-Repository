...
namespace biz.Common
{
	public class ProfileBiz : BaseBiz
	{
		...
		private ProfileDataAccess _datalayer;
		private ProfileDataAccess DataLayer
		{
			get { if (_datalayer == null) _datalayer = new ProfileDataAccess(); return _datalayer; }
		...
		public ProfileBiz () 
		{}
		public ProfileBiz ( Context _context ) :base(_context)
		{}
		#endregion
