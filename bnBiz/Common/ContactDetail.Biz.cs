...
{
	public class ContactDetailBiz : BaseBiz
	{
		#region Properties
		...
		private ContactDetailDataAccess _datalayer;
		private ContactDetailDataAccess DataLayer
		{
			get { if (_datalayer == null) _datalayer = new ContactDetailDataAccess(); return _datalayer; }
			set { _datalayer = value; }
		}
		#endregion
		#region Constructors
		
		public ContactDetailBiz () 
		{}
		public ContactDetailBiz ( Context _context ) :base(_context)
		{}
		#endregion
