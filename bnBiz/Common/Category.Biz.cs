...
{
	public class CategorieBiz : BaseBiz
	{
		#region Properties
		...
		private CategorieDataAccess _datalayer;
		private CategorieDataAccess DataLayer
		{
			get { if (_datalayer == null) _datalayer = new CategorieDataAccess(); return _datalayer; }
		...
		public CategorieBiz () 
		{}
		public CategorieBiz ( Context _context ) :base(_context)
		{}
		#endregion
