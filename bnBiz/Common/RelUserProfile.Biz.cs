...
{
	public class RelUserProfileBiz : BaseBiz
	{
		#region Properties
		...
		private RelUserProfileDataAccess _datalayer;
		private RelUserProfileDataAccess DataLayer
		{
			get { if (_datalayer == null) _datalayer = new RelUserProfileDataAccess(); return _datalayer; }
			set { _datalayer = value; }
		}
		#endregion
		#region Constructors
		
		public RelUserProfileBiz () 
		{}
		public RelUserProfileBiz ( Context _context ) :base(_context)
		{}
		#endregion
