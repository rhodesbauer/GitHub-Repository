...
{
	public class RelPhoneNumbersContactBiz : BaseBiz
	{
		#region Properties
		...
		private RelPhoneNumbersContactDataAccess _datalayer;
		private RelPhoneNumbersContactDataAccess DataLayer
		{
			get { if (_datalayer == null) _datalayer = new RelPhoneNumbersContactDataAccess(); return _datalayer; }
			set { _datalayer = value; }
		}
		#endregion
		#region Constructors
		
		public RelPhoneNumbersContactBiz () 
		{}
		public RelPhoneNumbersContactBiz ( Context _context ) :base(_context)
		{}
		#endregion
