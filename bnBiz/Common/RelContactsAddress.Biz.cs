...
{
	public class RelContactsAddresseBiz : BaseBiz
	{
		#region Properties
		...
		private RelContactsAddresseDataAccess _datalayer;
		private RelContactsAddresseDataAccess DataLayer
		{
			get { if (_datalayer == null) _datalayer = new RelContactsAddresseDataAccess(); return _datalayer; }
			set { _datalayer = value; }
		}
		#endregion
		#region Constructors
		
		public RelContactsAddresseBiz () 
		{}
		public RelContactsAddresseBiz ( Context _context ) :base(_context)
		{}
		#endregion
