...
{
	public class RelUserContactBiz : BaseBiz
	{
		#region Properties
		...
		private RelUserContactDataAccess _datalayer;
		private RelUserContactDataAccess DataLayer
		{
			get { if (_datalayer == null) _datalayer = new RelUserContactDataAccess(); return _datalayer; }
			set { _datalayer = value; }
		}
		#endregion
		#region Constructors
		
		public RelUserContactBiz () 
		{}
		public RelUserContactBiz ( Context _context ) :base(_context)
		{}
		#endregion
