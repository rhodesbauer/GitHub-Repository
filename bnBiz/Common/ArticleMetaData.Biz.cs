...
{
	public class ArticleMetaDataBiz : BaseBiz
	{
		#region Properties
		...
		private ArticleMetaDataDataAccess _datalayer;
		private ArticleMetaDataDataAccess DataLayer
		{
			get { if (_datalayer == null) _datalayer = new ArticleMetaDataDataAccess(); return _datalayer; }
			set { _datalayer = value; }
		}
		#endregion
		#region Constructors
		
		public ArticleMetaDataBiz () 
		{}
		public ArticleMetaDataBiz ( Context _context ) :base(_context)
		{}
		#endregion
